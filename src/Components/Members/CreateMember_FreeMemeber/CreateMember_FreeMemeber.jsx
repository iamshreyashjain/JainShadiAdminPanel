...
export default function CreateMember_FreeMemeber() {
    ...
    //---------------------------> behalfOf <---------------------------
    const [defaultTextBehalfOf, setdefaultTextBehalfOf] = useState("Select Behalf Of");
    ...
    //---------------------------> Package <---------------------------
    const [defaultTextPackage, setdefaultTextPackage] = useState("Select Package");
    ...
    const handleChange = (e) => {
        setdefaultFormData(
            {
                ...defaultFormData, [e.target.name]: e.target.value
            });
    };
        ...
        >
                ...
                >
                    ...
                    >
                        ...
                        {isDropDownGender && (
                            <div
                                className="top-10 absolute w-full rounded-md border border-gray-300 bg-white z-10">
                ...
                >
                    ...
                    >
                        ...
                        {isDropDownBehalfOf && (
                            <div
                                className="top-10.5 absolute w-full rounded-md border border-gray-300 bg-white overflow-y-scroll h-36">
                                <ul className="text-sm text-gray-500">
